...
export default function Home() {
  ...
  return (
    <div className={`flex-1 w-full flex flex-col items-center px-6 relative bg-slate-50 overflow-x-hidden ${showIntro ? 'h-[calc(100vh-80px)] overflow-hidden' : 'min-h-[calc(100vh-80px)]'}`}>
