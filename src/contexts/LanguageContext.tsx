...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'Raffle Details:': 'Raffle Details:',
    'Each survey completed = 1 entry': 'Each survey completed = 1 entry',
    'Max 3 surveys per person': 'Max 3 surveys per person',
    'Winners contacted by June 29th': 'Winners contacted by June 29th',
    'Other:': 'Other:',
  ...
  fr: {
    ...
    'Raffle Details:': 'Détails du tirage au sort :',
    'Each survey completed = 1 entry': 'Chaque sondage complété = 1 participation',
    'Max 3 surveys per person': 'Maximum de 3 sondages par personne',
    'Winners contacted by June 29th': 'Les gagnants seront contactés d\'ici le 29 juin',
    'Other:': 'Autre:',
  ...
  zh: {
    ...
    'Raffle Details:': '抽奖详情:',
    'Each survey completed = 1 entry': '完成1次调查 = 1次抽奖机会',
    'Max 3 surveys per person': '每人最多完成3次调查',
    'Winners contacted by June 29th': '将于6月29日前联系获奖者',
    'Other:': '其他:',
